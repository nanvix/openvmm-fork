...
pub fn aarch64_initial_regs(
    ...
    for &reg in init {
        match reg {
            ...
            Aarch64Register::X3(v) => state.registers.x3 = v,
            Aarch64Register::X4(v) => state.registers.x4 = v,
            Aarch64Register::X5(v) => state.registers.x5 = v,
            Aarch64Register::X6(v) => state.registers.x6 = v,
            Aarch64Register::X7(v) => state.registers.x7 = v,
